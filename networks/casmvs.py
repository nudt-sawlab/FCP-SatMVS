...
class CascadeMVSNet(nn.Module):
    def __init__(self, geo_model, refine=False, min_interval=2.5,
        ...
        # Cross-stage multi-scale feature fusion with CDAM attention.
    ...
    def forward(self, imgs, proj_matrices, depth_values):
        ...
        # Cache previous-stage probability volume and depth hypotheses for PUIP.
        prev_depth_samples = None
        prev_prob_volume = None

        # Group per-view multi-scale features for later fusion.
        ...
        for stage_idx in range(self.num_stage):
            ...
            # Cross-stage feature fusion via FFE.
            features_stage = []
            for nview_idx in range(imgs.size(1)):
            ...
            # PUIP: pixel-wise non-uniform depth sampling based on the
            # previous-stage probability volume.
            ...
            # Cache outputs for the next stage's PUIP.
